                    ...
                    <div className="flex items-center justify-end gap-1.5">
                      {insp.qcStatus === 'Pendiente' ? (
                        <button
                          ...
                          className="bg-[#004ac6] text-white px-3.5 py-1.5 rounded-lg text-[12px] font-bold hover:bg-[#2563eb] transition-colors inline-flex items-center gap-1.5 shadow-sm"
                        >
                        ...
                        <button
                          onClick={() => {
                            ...
                            else setSelectedInspectionForQC(insp);
                          }}
                          className="px-3 py-1.5 bg-white border border-[#c3c6d7] text-[#151c27] hover:bg-[#f0f3ff] hover:border-[#004ac6] rounded-lg text-[12px] font-semibold flex items-center gap-1.5 shadow-xs transition-colors"
                          title="Ver resultado de inspección"
                        >
