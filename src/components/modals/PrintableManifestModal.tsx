        ...
        >
          ...
          <div className="border-b-2 border-[#151c27] pb-4 flex justify-between items-start">
            <div className="space-y-1">
              ...
              <p className="text-[11px] font-semibold text-[#004ac6] print:text-black">
                Departamento de Despacho y Logística
              </p>
              <p className="text-[11px] text-[#555f6f] print:text-neutral-700">
                Planta de Fabricación • Parque Industrial Nave 4 • Certificación AISC & AWS D1.1
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-[#fafcff] border border-[#dce2f3] p-4 rounded-xl text-[12px] print:bg-slate-50 print:border-slate-300">
            ...
            <div>
              <span className="text-[#555f6f] block uppercase text-[10px] font-bold print:text-neutral-600">Dpto. Despacho / Logística:</span>
              <strong className="text-[#151c27] text-[12px] block print:text-black">{s.carrier}</strong>
              <span className="text-[11px] text-[#555f6f] block print:text-neutral-700">Coord: {s.manager}</span>
            </div>

            <div>
              <span className="text-[#555f6f] block uppercase text-[10px] font-bold print:text-neutral-600">Conductor Asignado:</span>
              <span className="font-semibold text-[#151c27] block text-[13px] print:text-black">
                {s.driverName || 'Roberto Mendoza'}
              </span>
              <span className="text-[11px] text-[#555f6f] print:text-neutral-700">Operador de Entrega</span>
            </div>
          ...
          <div className="p-3 bg-slate-50 border border-[#e2e8f8] rounded-lg text-[11px] text-[#555f6f] leading-relaxed print:bg-white print:border-slate-300 print:text-neutral-800">
            <strong>Certificación de Conformidad & Despacho:</strong> Los elementos amparados en este documento han sido fabricados conforme a las especificaciones técnicas, planos de taller aprobados y la norma AWS D1.1 / AISC 360. El Departamento de Despacho se hace responsable del correcto estibado, aseguramiento y traslado hacia obra.
          </div>
          ...
          <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-300 text-[11px]">
            <div className="text-center space-y-8">
              <div className="h-12 border-b border-slate-400 flex items-end justify-center pb-1">
                <span className="font-mono text-[10px] text-slate-500">{s.manager || 'Carlos Gómez (Coord. Despacho)'}</span>
              </div>
              <div>
                <strong className="block text-[#151c27] text-[12px] print:text-black">Dpto. de Despacho (Planta)</strong>
            ...
            <div className="text-center space-y-8">
              ...
              <div>
                <strong className="block text-[#151c27] text-[12px] print:text-black">Conductor / Operador Despacho</strong>
                <span className="text-[#737686] print:text-neutral-700">{s.carrier}</span>
              </div>
            </div>
